<?
	...
	$img_size = getimagesize($_FILES['file']['tmp_name']);
		...
		//db에 저장할 정보 가져옴
		$file_time=date("His");
		$upload_filename = str_replace(".","$file_time.",$_FILES['file']['name']);
	...
	//$imgurl="./img/".$fileName;
	echo $imgurl=$upload_filename;
  // include("../query/dbconnect.php");
	// $query="INSERT INTO phoneting_contents(no,title,text,phone,uri) VALUES(NULL,'".$_POST['title']."','".$_POST['text']."','".$_POST['phone']."','".$imgurl."')";
